...
const ConsultationCTA = () => {
  ...
  return (
    <section className="w-full py-8">
      <div className="bg-[#054425] rounded-3xl p-8 md:p-10 text-center relative overflow-hidden group max-w-lg mx-auto shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
        ...
        <div className="relative z-10 mx-auto">
          <h2 className="text-xl md:text-2xl font-serif font-black text-white mb-2 leading-tight italic transform group-hover:scale-105 transition-transform duration-500">
            Divine <span className="text-brand-gold">Personalization</span>
          </h2>
          <p className="text-white/80 text-[9px] md:text-[10px] mb-6 font-serif leading-relaxed px-4 opacity-80 group-hover:opacity-100 transition-opacity duration-500">
              ...
              {isSubmitted ? (
                ...
                <>
                  <div className="mb-8">
                    ...
                    <h3 className="text-2xl font-serif font-black text-[#054425]">Book Your Ritual</h3>
                    <div className="w-8 h-1 bg-brand-gold mt-3"></div>
                  </div>
